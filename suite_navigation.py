...
def install(app):
    ...
    def suite_navigation(response):
        ...
        # Seguimiento Integral vive únicamente en el menú principal lateral.
        ...
        # Acceso contextual desde Alumnos hacia sus expedientes.
        ...
        # Acceso contextual desde Inicio sin crear una segunda navegación persistente.
