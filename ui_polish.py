...
/* Iconos: sin relleno en reposo; dorado solamente en hover o estado activo */
.nav-icon,.quick-icon,.stat-icon,.recent-badge,.mini-mark,.avatar{
  ...
  transition:transform .2s var(--ui-ease),background .2s var(--ui-ease),color .2s var(--ui-ease),box-shadow .2s var(--ui-ease),border-color .2s var(--ui-ease)!important;
}

/* En superficies claras, icono vino sin fondo */
.quick-icon,.stat-icon,.recent-badge,.mini-mark{color:#7b1024!important}
.quick-icon svg,.stat-icon svg,.recent-badge svg,.mini-mark svg{stroke:currentColor!important}

/* En barra lateral, icono blanco sin fondo */
.nav-icon{color:#fff!important}
.nav-icon svg{stroke:currentColor!important}

/* Hover y activo: mismo tratamiento dorado */
.nav-link:hover .nav-icon,.nav-link.active .nav-icon,
.quick a:hover .quick-icon,.quick a.active .quick-icon,
.stat-card:hover .stat-icon,.stat-card.active .stat-icon,
.recent-item:hover .recent-badge,.recent-item.active .recent-badge{
  background:var(--ui-gold)!important;
  color:var(--ui-gold-dark)!important;
  border-color:rgba(202,164,95,.78)!important;
  box-shadow:0 9px 20px rgba(202,164,95,.28)!important;
...
.nav-link:hover{background:rgba(202,164,95,.12)!important;transform:translateX(3px)}
.nav-link.active{background:rgba(202,164,95,.18)!important;color:#fff!important}
.nav-link .nav-icon{width:42px!important;height:42px!important;min-width:42px!important;min-height:42px!important;font-size:21px!important;border-radius:13px!important}
...
.quick a:before{content:"";position:absolute;inset:auto -30px -45px auto;width:90px;height:90px;border-radius:50%;background:rgba(202,164,95,.08);transition:transform .25s var(--ui-ease),background .25s var(--ui-ease)}
...
.quick a:hover:before{transform:scale(1.35);background:rgba(202,164,95,.15)}
.quick a:hover .quick-label,.quick a:hover .quick-sub{color:#fff!important}
.quick-icon{width:54px!important;height:54px!important;min-width:54px!important;min-height:54px!important;font-size:25px!important;border-radius:16px!important}

/* Rúbricas IA conserva la misma regla: sin relleno en reposo */
.quick a.rubric-ai-card{background:linear-gradient(145deg,#fff 0%,#fff9f4 100%)!important;border-color:rgba(202,164,95,.22)!important}
.quick a.rubric-ai-card .quick-icon{background:transparent!important;color:#7b1024!important;box-shadow:none!important;border-color:transparent!important}
...
.quick a.rubric-ai-card:hover .quick-icon{background:var(--ui-gold)!important;color:var(--ui-gold-dark)!important;box-shadow:0 9px 20px rgba(202,164,95,.28)!important}

/* Métricas e iconos secundarios */
.stat-card{gap:16px!important}.stat-icon{width:58px!important;height:58px!important;min-width:58px!important;min-height:58px!important;border-radius:17px!important;font-size:26px!important}
.recent-badge{width:44px!important;height:44px!important;min-width:44px!important;min-height:44px!important;border-radius:14px!important;font-size:20px!important}
.mini-mark{width:54px!important;height:54px!important;min-width:54px!important;min-height:54px!important;border-radius:16px!important;font-size:24px!important}
.avatar{width:46px!important;height:46px!important;min-width:46px!important;min-height:46px!important;border-radius:14px!important;font-size:18px!important;background:transparent!important;color:#7b1024!important;border:1px solid rgba(123,16,36,.16)!important}
.admin-box:hover .avatar{background:var(--ui-gold)!important;color:var(--ui-gold-dark)!important;border-color:var(--ui-gold)!important;box-shadow:0 9px 20px rgba(202,164,95,.25)!important}
...
@media(max-width:720px){
  ...
  .quick-icon{width:48px!important;height:48px!important;min-width:48px!important;min-height:48px!important;font-size:23px!important}
  .nav-link .nav-icon{width:40px!important;height:40px!important;min-width:40px!important;min-height:40px!important}
}
</style>
'''
...
def install(app):
    ...
    def ui_polish(response):
        ...
        if '</head>' in html and 'id="ui-polish-v4"' not in html:
